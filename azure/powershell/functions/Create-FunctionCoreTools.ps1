...
# 2- Create a resource group named "rg-testapp1-shared-001" in the westus region.
#    New-AzResourceGroup -Name "rg-testapp1-shared-001" -Location westus
# 3- Create a general-purpose storage account in your resource group and region.
#    New-AzStorageAccount -ResourceGroupName "rg-testapp1-shared-001" -Name "stappdata001" -SkuName Standard_LRS -Location westus
# 4- Create the function app in Azure.
#    New-AzFunctionApp -Name <APP_NAME> -ResourceGroupName "rg-testapp1-shared-001" -StorageAccount "stappdata001" -Runtime dotnet -FunctionsVersion 3 -Location 'West US'
...
#    Remove-AzResourceGroup -Name "rg-testapp1-shared-001"
